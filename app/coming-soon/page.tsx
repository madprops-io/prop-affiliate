...
export default function ComingSoon() {
  const livePartners: Partner[] = [
    ...
    { name: "Funded Futures Network (FFN)", blurb: "Standard & Express evaluations.", href: "https://www.fundedfuturesnetwork.com/?via=madprops", logo: "/logos/ffn.png", status: "affiliate" },
    { name: "Bulenox", blurb: "Use Code MAD at checkout.", href: "https://bulenox.com/member/aff/go/tjcaldwell", logo: "/logos/bulenox.png", status: "affiliate" },
    ...
    { name: "FunderPro", blurb: "Popular evaluation paths.", href: "https://funderpro.cxclick.com/visit/?bta=44803&brand=funderpro", logo: "/logos/funderpro.png", status: "affiliate" },
  ...
  const comingSoon: Partner[] = [
    ...
    { name: "Trade Day", blurb: "Professional platform; daily payouts.", href: "https://www.tradeday.com/", logo: "/logos/tradeday.png", status: "pending" },
