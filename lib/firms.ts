...
export const AFFILIATE_LINKS: Record<string, string> = {
  ...
  bulenox: "",
  alphafutures: "",
  fundednextfutures: "https://fundednext.com/?ref=MADPROPS",
  aquafutures: "",
  e8futures: "",
  tradeday: "",
  phidias: "",
...
const RAW_FIRMS: Firm[] = [
  ...
  { key: "fundednextfutures", name: "FundedNext Futures", homepage: "", logo: "/logos/fundednext.png", model: [], platforms: [], maxFunding: 0, payout: 0.9, signup: "" },
